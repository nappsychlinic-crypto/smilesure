...
import { User, Phone, Save, Loader2, Lock, Eye, EyeOff } from 'lucide-react';
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                <div className="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100">
                    ...
                    <div>
                        ...
                        <span className="inline-block mt-1 px-3 py-1 text-sm font-medium bg-green-100 text-green-700 rounded-full">
                            Patient
                        </span>
                    </div>
                </div>
